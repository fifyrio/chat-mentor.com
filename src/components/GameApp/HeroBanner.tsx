        ...
        <div className="container">
          <div className="grid gap-[30px] items-end grid-cols-1 md:grid-cols-1 lg:grid-cols-2">
            <div className="space-y-[30px] md:space-y-[40px] lg:space-y-[30px] xl:space-y-[40px] md:max-w-[590px] mx-auto lg:mx-0 text-center lg:text-start lg:pb-[60px] xl:pb-[70px] 2xl:pb-[150px]">
              ...
              <div
                className="space-x-[15px] md:space-x-[30px] space-y-[15px] sm:space-y-[0]"
                data-aos="fade-left"
                data-aos-delay="300"
                data-aos-duration="600"
                data-aos-once="true"
              >
                ...
                >
                  <div className="flex items-center space-x-[10px] bg-[#EBEBEB] py-[10px] px-[34px] rounded-full transition duration-500 ease-in-out group hover:bg-black-color">
                ...
                <a
                  ...
                  className="inline-block"
                >
                  <div className="flex items-center space-x-[10px] bg-primary-color py-[10px] px-[34px] rounded-full transition duration-500 ease-in-out hover:bg-black-color">
              ...
              <div
                className="flex items-center justify-center lg:justify-start space-x-[15px]"
                data-aos="fade-left"
                data-aos-delay="400"
                data-aos-duration="600"
                data-aos-once="true"
              >
                ...
                <div>
                  <div className="text-[#FFC107] space-x-[3px] text-[16px]">
            ...
            <div className="text-center relative">
              ...
              <Image
                src={circleShape}
                alt="shape"
                className="absolute bottom-0 right-0 left-0 z-0 animate-pulse"
              />
            </div>
          </div>
        </div>
