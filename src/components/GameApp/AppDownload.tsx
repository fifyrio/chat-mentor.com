        ...
        <div className="container">
          <div className="bg-[#232323] rounded-[20px]">
            <div className="grid gap-[30px] md:gap-[50px] lg:gap-[30px] items-center grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3">
              <div 
                className="px-[20px] md:px-[40px] xl:pr-[0] pt-[30px] md:pt-[50px] lg:py-[30px] lg:w-[480px] xl:w-[520px] relative z-[1] xl:left-[20px] 2xl:left-[60px] mx-auto lg:mx-0 text-center lg:text-left"
                data-aos="fade-up"
                data-aos-delay='100'
              ...
              >
                ...
                <div className="mt-[30px] md:mt-[40px] lg:mt-[30px] xl:mt-[50px] space-x-[15px] md:space-x-[30px] space-y-[15px] sm:space-y-[0]">
                  <a
                    href="https://www.apple.com/store"
                    target="_blank"
                    className="inline-block"
                  >
                    <div className="flex items-center space-x-[10px] bg-red-color py-[10px] px-[34px] rounded-full transition duration-500 ease-in-out hover:bg-primary-color">
                  ...
                  <a
                    ...
                    className="inline-block"
                  >
                    <div className="flex items-center space-x-[10px] bg-primary-color py-[10px] px-[34px] rounded-full transition duration-500 ease-in-out hover:bg-red-color">
              ...
              <div 
                className="lg:col-span-2 relative text-end lg:pl-[50px] xl:pl-[0]"
                data-aos="fade-down"
                data-aos-delay='200'
                data-aos-duration="600"
                data-aos-once="false"
