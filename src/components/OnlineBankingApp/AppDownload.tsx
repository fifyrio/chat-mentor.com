        ...
        <div className="container">
          ...
          >
            <div className="grid gap-[30px] md:gap-[50px] lg:gap-[60px] items-end grid-cols-1 md:grid-cols-1 lg:grid-cols-2">
              <div 
                className="max-w-[560px] mx-auto lg:mx-0 text-center lg:text-left lg:pb-[50px] xl:pb-[50px] 2xl:pb-[100px]"
                data-aos="fade-in"
                data-aos-delay='100'
              ...
              >
                ...
                <div className="mt-[30px] md:mt-[50px] space-x-[15px] md:space-x-[30px] space-y-[15px] sm:space-y-[0]">
                  <a
