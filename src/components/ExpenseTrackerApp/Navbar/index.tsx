      ...
      >
        <div className="container mx-auto max-w-[1760px] xl:px-[30px]">
          ...
          >
            ...
            <div className="navbar-collapse flex self-center grow basis-auto md:space-x-[20px] lg:space-x-[50px] xl:space-x-[70px] 2xl:space-x-[100px]">
              <ul className="navbar-nav self-center flex-row ml-auto md:flex md:space-x-[15px] lg:space-x-[25px] xl:space-x-[35px] 2xl:space-x-[50px]">
              ...
              {/* Other options */}
              <div className="other-options self-center space-x-[20px] lg:space-x-[25px] xl:space-x-[45px]">
                <Link
                  href="/login"
