    ...
    <>
      <div id="about" className="container xl:p-0 xl:max-w-[1920px]">
        <div className="grid gap-[40px] items-center grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2">
          <div className="space-y-[30px] md:space-y-[50px] lg:max-w-[630px] lg:mr-auto xl:mr-0 lg:ml-auto">
            <div
              data-aos="fade-in"
              data-aos-delay="100"
              ...
              >
                {featuresData &&
                  featuresData.slice(0, 3).map((value, i) => (
                    <div className="flex space-x-[18px] group" key={i}>
            ...
            <div
              className="space-y-[15px] sm:space-y-[0] space-x-[15px] md:space-x-[30px]"
              data-aos="fade-in"
              data-aos-delay="300"
              data-aos-duration="600"
              data-aos-once="false"
