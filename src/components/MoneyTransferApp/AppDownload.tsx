        ...
        <div className="bg-[#00373E] max-w-[1700px] mx-auto rounded-[20px] py-[60px] overflow-hidden">
          <div className="container">
            <div className="grid gap-[40px] items-center grid-cols-1 md:grid-cols-1 lg:grid-cols-2">
              <div 
                className="max-w-[560px] mx-auto lg:mx-0 text-center lg:text-left"
                data-aos="fade-down"
                data-aos-delay='100'
              ...
              >
                ...
                <div className="mt-[30px] md:mt-[50px] space-x-[15px] md:space-x-[30px] space-y-[15px] sm:space-y-[0]">
                  ...
                  >
                    <div className="flex items-center space-x-[10px] bg-[#FBAD9C] py-[10px] px-[34px] rounded-full transition duration-500 ease-in-out group hover:bg-[#000]">
                  ...
                  <a
                    ...
                    className="inline-block"
                  >
                    <div className="flex items-center space-x-[10px] bg-[#CAFFF2] py-[10px] px-[34px] rounded-full transition duration-500 ease-in-out hover:bg-[#f9e3e3]">
