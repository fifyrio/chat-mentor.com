      ...
      <div id="testimonials" className="py-[50px] md:py-[70px] lg:py-[100px] xl:py-[120px] overflow-hidden">
        <div className="container xl:p-0 xl:max-w-[1920px] relative left-55">
          <div className="grid gap-[30px] items-center grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3">
            <div
              className="max-w-[500px] text-center lg:text-start mx-auto lg:mx-0 lg:ml-auto xl:max-w-[356px]"
              data-aos="fade-down"
              data-aos-delay="100"
                ...
                >
                  {testimonialsData &&
                    testimonialsData.map((value, i) => (
                      ...
                      >
                        <div className="flex items-center space-x-[10px] mb-[20px] md:mb-[30px]">
                        ...
                        <div className="flex items-center space-x-[15px] mt-[20px] md:mt-[30px]">
                          <div>
                            <Image
                              src={value.image}
                              alt="user"
