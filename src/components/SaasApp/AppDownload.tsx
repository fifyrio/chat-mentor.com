        ...
        <div className="container">
          <div className="bg-primary-color rounded-[20px] py-[50px] pl-[30px] pr-[30px]">
            <div className="grid gap-[30px] items-center grid-cols-1 md:grid-cols-1 lg:grid-cols-2">
              <div 
                className="max-w-[530px] mx-auto lg:mx-0 text-center lg:text-left relative pl-[20px] 2xl:pl-[0] 2xl:left-[80px]"
                data-aos="fade-up"
                data-aos-delay='100'
              ...
              >
                ...
                <div className="mt-[20px] md:mt-[30px] lg:mt-[50px] space-x-[15px] md:space-x-[30px] space-y-[15px] sm:space-y-[0]">
                  <a
                    href="https://www.apple.com/store"
                    target="_blank"
                    className="inline-block"
                  >
                    <div className="flex items-center space-x-[10px] bg-[#A673EE] py-[10px] px-[34px] rounded-full transition duration-500 ease-in-out hover:bg-[#9870d1]">
                  ...
                  <a
                    ...
                    className="inline-block"
                  >
                    <div className="flex items-center space-x-[10px] bg-[#262A37] py-[10px] px-[34px] rounded-full transition duration-500 ease-in-out hover:bg-[#000]">
